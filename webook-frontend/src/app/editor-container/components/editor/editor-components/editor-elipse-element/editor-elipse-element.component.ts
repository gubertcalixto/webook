...
@Component({
  selector: 'wb-editor-elipse-component',
  templateUrl: './editor-elipse-element.component.html',
  styleUrls: ['./editor-elipse-element.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditorElipseElementComponent extends EditorResizeBaseElement {
  private initialWidth = 200;
  private initialHeight = 200;
  private initialColor = '#000';
  public elementTypeId = 'wb-elipse';
