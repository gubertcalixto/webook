...
} from 'src/app/editor-container/components/editor/editor-components/editor-checkbox-element/editor-checkbox-element.component';
import {
  EditorImageElementComponent,
} from 'src/app/editor-container/components/editor/editor-components/editor-image-element/editor-image-element.component';
import {
  EditorRadioElementComponent,
} from 'src/app/editor-container/components/editor/editor-components/editor-radio-element/editor-radio-element.component';
import {
  EditorSliderElementComponent,
} from 'src/app/editor-container/components/editor/editor-components/editor-slider-element/editor-slider-element.component';
import {
  EditorSquareElementComponent,
} from 'src/app/editor-container/components/editor/editor-components/editor-square-element/editor-square-element.component';
import {
...
export const editorDefaultElements: EditorElementDefinition[] = [
  ...
  {
    elementId: 'square',
    elementClass: EditorSquareElementComponent,
    pluginId: 'default',
    label: 'Quadradro',
    icon: 'square',
    imagePreviewPath: undefined,
